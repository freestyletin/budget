...
class Transaction(models.Model):
    ...
    total_custom = models.DecimalField('Custom Total', max_digits=10, decimal_places=2, blank=True)
    tax_total_custom = models.DecimalField('Custom Tax Total', max_digits=10, decimal_places=2, blank=True)
    tip_total = models.DecimalField('Tip Total', max_digits=10, decimal_places=2, blank=True)
    bags_total = models.DecimalField('Bags Total', max_digits=10, decimal_places=2, blank=True)
    donation_total = models.DecimalField('Donation Total', max_digits=10, decimal_places=2, blank=True)
    grand_total_custom = models.DecimalField('Custom Grand Total', max_digits=10, decimal_places=2, blank=True)
