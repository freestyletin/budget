...
class Transaction(models.Model):
    ...
    def total_from_transactiondetail(self):
        price_final_total = Transaction.objects.annotate(total=Sum('transactiondetail_as_transaction_set__quantity'))
...
class TransactionDetail(models.Model):
    ...
    item = models.ForeignKey('items.Item', blank=True, null=True, on_delete=models.SET_NULL, related_name='transactiondetail_as_item_set')
